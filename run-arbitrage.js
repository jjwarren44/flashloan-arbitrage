...
const AMOUNT_ETH = 5;
const RECENT_ETH_PRICE = 4000; // TODO: use API to regular update ETH price
        ...
        .on("data", async block => {
            ...
            const kyberResults = await Promise.all([
                ...
                .getExpectedRate(
                    ...
                    "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", // ETH address for Kyber
                    AMOUNT_DAI_WEI
                )
                .call(),
            ...
            gasCost = 200000 // TODO: will figure out in flashloan smart contract
